...
sound[0] = new Audio("../Aufgabe_8/A.mp3");
sound[1] = new Audio("../Aufgabe_8/C.mp3");
sound[2] = new Audio("../Aufgabe_8/F.mp3");
sound[3] = new Audio("../Aufgabe_8/G.mp3");
sound[4] = new Audio("../Aufgabe_8/hihat.mp3");
sound[5] = new Audio("../Aufgabe_8/kick.mp3");
sound[6] = new Audio("../Aufgabe_8/snare.mp3");
sound[7] = new Audio("../Aufgabe_8/laugh2.mp3");
sound[8] = new Audio("../Aufgabe_8/laugh1.mp3");
